...
class TownsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post towns_url, params: { town: { country_name: @town.country_name, town_name: @town.town_name } }
    end
  ...
  test "should update town" do
    patch town_url(@town), params: { town: { country_name: @town.country_name, town_name: @town.town_name } }
